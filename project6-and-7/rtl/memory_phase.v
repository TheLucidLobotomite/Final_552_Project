...
module memory_phase (
    ...
    assign store_mask = store_sel[1] ? 4'b1111 :
                        ((~store_sel[1]) & store_sel[0]) ? (byte_offset[1] ? 4'b1100 : 4'b0011) :
                        (byte_offset == 2'b00) ? 4'b0001 :
                        (byte_offset == 2'b01) ? 4'b0010 :
                        (byte_offset == 2'b10) ? 4'b0100 :
                                                 4'b1000;

    assign load_mask  = load_sel[1] ? 4'b1111 :
                        ((~load_sel[1]) & load_sel[0]) ? (byte_offset[1] ? 4'b1100 : 4'b0011) :
                        (byte_offset == 2'b00) ? 4'b0001 :
                        (byte_offset == 2'b01) ? 4'b0010 :
                        (byte_offset == 2'b10) ? 4'b0100 :
                                                 4'b1000;
